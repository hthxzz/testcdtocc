...
export default {
    ...
    basemap: {
        ...
        baselayers: [

            {
                ...
                layerName: "地形图",
                type: "agsTiled",
                // url: "/api/TOCCMAP20191212/arcgis/rest/services/TOCC/TOCCMAP20191212/MapServer/tile",
            ...
            },
            {
                ...
                url: "/api/jiaotongju/arcgis/rest/services/jiaotongju/MAP20191210/MapServer/tile",
    ...
    vectorlayers: {
        ...
        BUS_STATION: {
            ...
            /**Themaximumresolution(inclusive)atwhichthislayerwillbevisible.*/
            zoomSymbols: [{
                minResolution: 0.000010740886980317885,
                /**Theminimumresolution(inclusive)atwhichthislayerwillbevisible.*/
                maxResolution: 100000000,
                /**Themaximumresolution(inclusive)atwhichthislayerwillbevisible.*/
                filter: "none",
                ...
                symbols: [{
                    value: "#DEFAULT#",
                    imageSrc: "http://192.167.252.246:8088/view/img/smallPoint1.png",

                }]
            },{
                minResolution: 0,
                /**Theminimumresolution(inclusive)atwhichthislayerwillbevisible.*/
                maxResolution: 0.000010740886980317885,
                /**Themaximumresolution(inclusive)atwhichthislayerwillbevisible.*/
                filter: "none",
                /**nonerandomfunction(feature){returnrendererValue}*/
                symbols: [{
        ...
        BUS_HUB_STATION: {
            ...
            zoomSymbols: [{
                ...
                symbols: [{
                    value: "#DEFAULT#",
                    imageSrc: "http://192.167.252.246:8088/view/img/bus_hub_station.png",
        ...
        BUS_ONLINE: {
            ...
            zoomSymbols: [{
                ...
                symbols: [
                    ...
                    {
                        value: "2"||"4",
                        imageSrc: "http://192.167.252.246:8088/view/img/smallPoint3.png",
                    },
                    {
                        value: "1"||"7",
                        imageSrc: "http://192.167.252.246:8088/view/img/smallPoint4.png",
                    },
                    {
                        value: "3"||"5"||"6",
                        imageSrc: "http://192.167.252.246:8088/view/img/smallPoint1.png",
                    ...
                    {
                        value: "8",
                        imageSrc: "http://192.167.252.246:8088/view/img/smallPoint7.png",
                ...
                symbols: [
                    ...
                    {
                        value: "2"||"4",
                        imageSrc: "http://192.167.252.246:8088/view/img/busG.png",
                    },
                    {
                        value: "1"||"7",
                        imageSrc: "http://192.167.252.246:8088/view/img/busQt.png",
                    },
                    {
                        value: "3"||"5"||"6",
                        imageSrc: "http://192.167.252.246:8088/view/img/bus.png",
                    ...
                    {
                        value: "8",
                        imageSrc: "http://192.167.252.246:8088/view/img/busCNG.png",
