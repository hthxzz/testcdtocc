        ...
        <div class="OperationComplaint-wrapper">
          ...
          >
            ...
            >
              ...
              <el-table-column label="行政处罚次数" prop="stationName" :formatter="this.formateTraffic"></el-table-column>
              <el-table-column
                :label="titleName1"
                prop="stationName"
              ...
              <el-table-column label="平均单车行政处罚次数" prop="staticDate"></el-table-column>
              <el-table-column
                :label="titleName2"
  ...
  methods: {
    ...
    getSearchValue(val) {
      ...
      if (val.frequency == "年") {
        ...
        this.searchConfig.searchCondition[3].type = this.searchConfig.searchCondition[2].type =
          "year";
        this.searchConfig.searchCondition[3].formate = this.searchConfig.searchCondition[2].formate =
          "yyyy";
        this.searchConfig.searchCondition[3].VModelvalue.defaultValue = this.searchConfig.searchCondition[2].VModelvalue.defaultValue = this.$utils
          .dayjs()
          .format("YYYY");
