                ...
                <div class="OperationComplaint-wrapper">
                    ...
                    >
                        ...
                        >
                            ...
                            <el-table-column label="总投诉(次)" prop="stationName" :formatter="this.formateTraffic"></el-table-column>
                            <el-table-column label="投诉次数与去年同期同比" prop="stationName" :formatter="this.formateTraffic"></el-table-column>
                            <!-- <el-table-column label="统计方式" prop="hour"></el-table-column> -->
                            <el-table-column label="服务投诉次数" prop="staticDate" ></el-table-column>
                            <el-table-column label="安全投诉次数" prop="passengerVolumeYoy" :formatter="this.formateTraffic"> </el-table-column>
                            <el-table-column label="营运投诉次数" prop="passengerVolumeYoy" :formatter="this.formateTraffic"> </el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            getPassengerFlowByPage(data,serchVal) {
                ...
                yy=[
                    50, 91, 24, 26, 27, 30, 30, 30, 27, 28, 21,20,14,12,71,
                    7,94,22,22,33,39,36,29,28,35,24,26,27,24,20
                ];
                fw=[
                    9, 17, 55, 10, 19, 33, 44, 85, 8, 9, 17,2,55,10,19,
                    3,44,85,8,72,36,93,62,10,19,55,10,19,84,78
                ];
                aq=[
                    59, 97, 25, 20, 29, 33, 34, 35, 28, 29, 27,12,45,21,9,
                    73,94,25,28,37,36,69,92,21,59,45,26,19,4,8
                ];
                var testData2= {
