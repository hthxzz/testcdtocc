                ...
                <div class="OperationComplaint-wrapper">
                    ...
                    >
                        ...
                        >
                            ...
                            <el-table-column label="时间段开始时间" prop="lineName"></el-table-column>
                            <el-table-column label="时间段结束时间" prop="lineName"></el-table-column>
                            <el-table-column label="发车间隔时间范围（分钟）" prop="lineName"></el-table-column>
                            <el-table-column label="线路数" prop="lineName"></el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            getPassengerFlowByPage(data,serchVal) {
                ...
                xls=[27,5, 9, 24, 2, 19, 3];
                var testData2= {
                    title:'各发车间隔时间的线路数统计情况',
                    unitName: '(线路数/路)',
                    xAxisData: ['0-3','3-5','5-8','8-12','12-20','20-30','30以上'],
                    legendData:['线路数'],
                    seriesData:[xls],
                };
                this.option3 =this.$utils.echart.creatEchartOption_5_3(testData2);
