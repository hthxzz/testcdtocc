                ...
                <div class="OperationComplaint-wrapper">
                    ...
                    >
                        ...
                        >
                            ...
                            <el-table-column label="车辆故障" prop="staticDate" ></el-table-column>
                            <el-table-column label="与昨日环比" prop="passengerVolumeYoy" :formatter="this.formateTraffic"> </el-table-column>
