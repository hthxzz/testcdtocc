                ...
                <div class="OperationComplaint-wrapper">
                    ...
                    >
                        ...
                        >
                            ...
                            <el-table-column label="客运量(万人次)" prop="stationName" :formatter="this.formateTraffic"></el-table-column>
                            <!-- <el-table-column label="统计方式" prop="hour"></el-table-column> -->
                            <el-table-column label="客运量环比" prop="staticDate" ></el-table-column>
