        ...
        <BaseLayoutContent>
            <template #leftPanel>
                <panel>
                    <PanelItem title="实时流量监测">
                        <span>当前机场客流量</span>
                        <Count figure="5299" widthNum="32px" fontNum="28px">
                        </Count>
                        <span>机场年总客流量</span>
                        <Count figure="529345" widthNum="32px" fontNum="28px"></Count>
                        <ul class="carNum">
                            <li >
                                <span>21</span>
                                <p>出租车数量</p>
            ...
            <template #midContent>
                <div style="position:absolute">
                    ...
                    <Count figure="9126" >
                        <template #suffix>
                            <span style="font-size: 20px;line-height: 90px;">人</span>
                        </template>
                    ...
                    <PanelItem title="重点区域监测">
                        ...
                        <div class="barOrLineClass">
                            <barOrLine-option :echartData="passengerTrafficData" echartType="bar"
                                              echartTitle="" :ifShowLable="true":barWidth="15"></barOrLine-option>
                        </div>
