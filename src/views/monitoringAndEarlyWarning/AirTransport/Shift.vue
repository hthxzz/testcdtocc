            ...
            <div class="item" v-if="tableOneShow" >
                ...
                >
                    <el-table style="width: 100%;height:100%;overflow-y: auto" :height="tableHeight" :data="tableData" stripe ref="table" >
                        ...
                        <el-table-column type="expand">
                            <template slot-scope="props">
                                <el-form label-position="left" inline class="demo-table-expand">
                                    ...
                                    <el-form-item label="进港班次">
                                        <span>{{ props.row.comeNum }}</span>
                                    </el-form-item>
                                    <el-form-item label="进港延误">
                                        <span>{{ props.row.comeDelayNum }}</span>
                                    </el-form-item>
                                    <el-form-item label="进港取消">
                                        <span>{{ props.row.comeCancelNum }}</span>
                                    </el-form-item>
                                    <el-form-item label="进港延误率">
                                        <span>{{ props.row.comeDelayRate }}</span>
                                    </el-form-item>
                                    <el-form-item label="进港取消率">
                                        <span>{{ props.row.comeCancelRate }}</span>
                                    </el-form-item>
                                    <el-form-item label="出港班次">
                                        <span>{{ props.row.outNum }}</span>
                                    </el-form-item>
                                    <el-form-item label="出港延误">
                                        <span>{{ props.row.outDelayNum }}</span>
                                    </el-form-item>
                                    <el-form-item label="出港取消">
                                        <span>{{ props.row.outCancelNum }}</span>
                                    </el-form-item>
                                    <el-form-item label="出港延误率">
                                        <span>{{ props.row.outDelayRate }}</span>
                                    </el-form-item>
                                    <el-form-item label="出港取消率">
                                        <span>{{ props.row.outCancelRate }}</span>
                                    </el-form-item>
                                </el-form>
                            </template>
                        </el-table-column>
                        ...
                        <el-table-column label="进港班次" prop="comeNum"></el-table-column>
                        <el-table-column label="进港延误" prop="comeDelayNum"></el-table-column>
                        <el-table-column label="进港取消" prop="comeCancelNum"> </el-table-column>
                        <el-table-column label="进港延误率" prop="comeDelayRate"></el-table-column>
                        <el-table-column label="进港取消率"prop=".comeCancelRate"></el-table-column>
                        <el-table-column label="出港班次"prop="outNum"></el-table-column>
                        <el-table-column label="出港延误"prop="outDelayNum"></el-table-column>
                        <el-table-column label="出港取消"prop="outCancelNum"></el-table-column>
                        <el-table-column label="出港延误率"prop="outDelayRate"> </el-table-column>
                        <el-table-column label="出港取消率"prop="outCancelRate"> </el-table-column>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            dealWithData(data){
                this.totalShift=data.totalFlightNum==null?0:data.totalFlightNum;
                if(data.statistics!=null&&data.statistics.length>0){
                    ...
                    data.statistics.forEach(e =>{
                        ...
                        value1.push(e. comeNum);
                        value2.push(e.outNum);
                    });
