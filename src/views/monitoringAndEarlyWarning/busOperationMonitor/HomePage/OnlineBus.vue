            ...
            <template #midContent>
                ...
                <div>
                    <div class="bottom" >
                        <table>
                            <tr>
                                <th  v-for="item in mapLegendOnline.list" :key="item.name">
                    ...
                    <PanelItem title :displaySwitch="false">
                        <div class="panel-wrapper right">
                            <div class="right-content">
                                <div class="left-item" @click="activeBusDD">
                                    <div class="title">
                                        <ul>
                                            <li>电动公交车(辆)</li>
                                        </ul>
                                    ...
                                    <div class="content">
                                        <ul>
                                            <li><count-to :startVal="0" :endVal="ddBus" :duration="4000" /></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="left-item" @click="activeBusCNG">
                                    <div class="title">
                                        <ul>
                                            <li>CNG(辆)</li>
                                        </ul>
                                    ...
                                    <div class="content">
                                        <ul>
                                            <li><count-to :startVal="0" :endVal="cngBus" :duration="4000" /></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="left-item" @click="activeBusLNG">
                                    <div class="title">
                                        <ul>
                                            <li>混合动力(辆)</li>
                                        </ul>
                                    ...
                                    <div class="content">
                                        <ul>
                                            <li><count-to :startVal="0" :endVal="hhBus" :duration="4000" /></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="left-item" @click="activeBusDiesel">
                                    <div class="title">
                                        <ul>
                                            <li>柴油(辆)</li>
                                        </ul>
                                    ...
                                    <div class="content">
                                        <ul>
                                            <li><count-to :startVal="0" :endVal="cyBus" :duration="4000" /></li>
                                        </ul>
                                    </div>
                                </div>
