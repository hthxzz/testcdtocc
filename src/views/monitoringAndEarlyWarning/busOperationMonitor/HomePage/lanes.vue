                    ...
                    <PanelItem title :displaySwitch="false">
                        <div class="panel-wrapper left">
                            <div class="left-content">
                                ...
                                <div class="left-item" @click="activeZYD">
                                    <div class="title">
                                        <ul>
                                            <li>公交专用道  <span>{{busLane}}  <span class="unitName">条</span></span></li>
                                            <li>{{busLaneLength}}<span> 公里</span></li>
                                        </ul>
                                    </div>
                                    <div class="content">
                                        <ul>
                                            <li></li>
                                            <li>{{busLaneSpeed}}<span> km/h</span></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="left-item" @click="activeLaneQuick">
                                    <div class="title">
                                        <ul>
                                            <li>双向全天候  <span>{{busLaneQuick}}  <span class="unitName">条</span></span></li>
                                            <li>{{busLaneQuickLen.toFixed(2)}}<span> 公里</span></li>
                                        </ul>
                                    </div>
                                    <div class="content">
                                        <ul>
                                            <li></li>
                                            <li>{{busLaneQuickSpeed}}<span> km/h</span></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="left-item" @click="activeLaneOneway">
                                    <div class="title">
                                        <ul>
                                            <li>单向全天候  <span>{{busLaneOneway}}  <span class="unitName">条</span></span></li>
                                            <li>{{busLaneOnewayLen.toFixed(2)}}<span> 公里</span></li>
                                        </ul>
                                    </div>
                                    <div class="content">
                                        <ul>
                                            <li></li>
                                            <li>{{busLaneOnewaySpeed}}<span> km/h</span></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="left-item" @click="activeLaneDay">
                                    <div class="title">
                                        <ul>
                                            <li>白天时段  <span>{{busLaneDay}}  <span class="unitName">条</span></span></li>
                                            <li>{{busLaneDayLen.toFixed(2)}}<span>公里</span></li>
                                        </ul>
                                    </div>
                                    <div class="content">
                                        <ul>
                                            <li></li>
                                            <li>{{busLaneDaySpeed}}<span> km/h</span></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="left-item" @click="activeLanePeak">
                                    <div class="title">
                                        <ul>
                                            <li>高峰时段  <span>{{busLanePeak}}  <span class="unitName">条</span></span></li>
                                            <li>{{busLanePeakLen.toFixed(2)}}<span>公里</span></li>
                                        </ul>
                                    </div>
                                    <div class="content">
                                        <ul>
                                            <li></li>
                                            <li>{{busLanePeakSpeed}}<span> km/h</span></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="left-item" @click="activeLaneTide">
                                    <div class="title">
                                        <ul>
                                            <li>潮汐  <span>{{busLaneTide}}  <span class="unitName">条</span></span></li>
                                            <li>{{busLaneTideLen.toFixed(2)}}<span> 公里</span></li>
                                        </ul>
                                    </div>
                                    <div class="content">
                                        <ul>
                                            <li></li>
                                            <li>{{busLaneTideSpeed}}<span> km/h</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
            ...
            <template #midContent>
                ...
                <div>
                    <div class="bottom" >
                        <table>
                            <tr>
                                <th  v-for="item in mapLegendLane.list" :key="item.name">
    ...
    export default {
        ...
        methods: {
            ...
            dealWithBusLaneInfo(data) {
                ...
                this.busLaneLength = data.busTopicBusLaneStatisticModel.busLaneLength == null?0:parseFloat(data.busTopicBusLaneStatisticModel.busLaneLength).toFixed(2);
                if ( data.busTopicBusLaneList !== null && data.busTopicBusLaneList.length > 0 ) {
                    ...
                    this.laneSpeedOption = this.creatOption2(
