<template>
  <div class="CyclingTime-wrapper nomap-content-container">
    ...
    <section class="echar-wrapper">
      <div class="item">
        <div class="echar-pie" style="height: 260px;margin-left:10px;">
          <v-chart :options="option" theme="theme"/>
        </div>
      </div>
    </section>
      ...
      <div class="item">
        ...
        >
          ...
          >
            ...
            <el-table-column label="时间" prop="hour"></el-table-column>
            <el-table-column label="百分比" prop="ratio"></el-table-column>
            <el-table-column label="订单数量" prop="useNum"></el-table-column>
            <el-table-column label="工作日订单" prop="workNum" :formatter="workCountFormat"></el-table-column>
            <el-table-column label="节假日订单" prop="restNum" :formatter="restCountFormat"></el-table-column>
          </el-table>
        </TableAndPagination>
      </div>
    </section>
