...
<template>
  ...
  <div class="infor-manage-wrap nomap-content-container">
    <div class="infor-manage-title">
      <div class="item"></div>
      <div class="item basicInfor active" @click="activeTab1($event)">站点客流总量</div>
      <div class="item">|</div>
      <div class="item argumentSet" @click="activeTab2($event)">线路客流量排名</div>
      <div class="line1"></div>
      <div class="line2"></div>
    </div>
...
import zdkll from "./components/OperationAnalysis/zdkll.vue";
import xlkl from "./components/OperationAnalysis/xlkl.vue";
export default {
  name: "",
  components: {
    zdkll,
