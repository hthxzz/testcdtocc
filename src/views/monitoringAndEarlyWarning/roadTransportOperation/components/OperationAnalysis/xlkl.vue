              ...
              <div class="OperationComplaint-wrapper">
                ...
                >
                  ...
                  >
                    ...
                    <el-table-column label="线路客流" prop="lineFlow"></el-table-column>
                    <el-table-column label="同比" prop="yearonyear"></el-table-column>
                    <el-table-column label="起始客运站名称" prop="startStation"></el-table-column>
                    <el-table-column label="终点客运站名称" prop="endStation"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    getLinePassengerTopTen(val1, val2) {
      this.$http
        .$get("kyjc_statisticHandler/getLinePassengerTopTen", {
          cycleType: val1 || "year",
    ...
    getMostPassengerLineByDate(val1, val2) {
      this.$http
        .$get("kyjc_statisticHandler/getMostPassengerLineByDate", {
          cycleType: val1 || "year",
          date: val2 || this.$utils.dayjs().year()
        })
        .then(res => {
  ...
  data() {
    return {
      ...
      url: "/kyjc_statisticHandler/getLineFlowByPage",
      option1: {},
      option2: {},
      option3: {},
      stationName: "",
