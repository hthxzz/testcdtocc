        ...
        <div class="itemList">
          <section>
            ...
            <div class="indexContent">
              <div class="top" v-loading="loading1">
                <v-chart :options="option1" />
              </div>
              <div class="bot" v-loading="loading2">
          ...
          <section>
            ...
            <div class="indexContent" style="height:560px">
              <div class="top" v-loading="loading3">
...
export default {
  ...
  methods: {
    ...
    getStationPassengerFlow(val1, val2) {
      this.$http
        .$get("kyjc_statisticHandler/getStationCapacity", {
          cycleType: val1 || "year",
    ...
    getPassengerFlowByPage(val) {
      // debugger;
      this.$http
        .$get("kyjc_statisticHandler/getStationCapacityByDateAndStation", val)
        .then(res => {
          // this.getSearchTableValue();
          const xAxisData = [];
          const seriesData = [];
  ...
  data() {
    return {
      ...
      url: "/kyjc_statisticHandler/getStationCapacityByPage",
      option1: {},
      option2: {},
      option3: {},
      loading1: true,
