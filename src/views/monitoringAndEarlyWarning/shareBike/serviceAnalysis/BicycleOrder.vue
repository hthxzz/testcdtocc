            ...
            <div class="item">
              ...
              >
                ...
                >
                  ...
                  <el-table-column label="非工作日日均客流" prop="nonWorkDayAvgFlow"></el-table-column>
                  <!-- <el-table-column label="统计方式" prop="hour"></el-table-column> -->
                  <el-table-column label="非工作日同比" prop="nonWorkDayAvgFlowYoy"></el-table-column>
                  <el-table-column label="工作日日均客流" prop="workDayAvgFlow"></el-table-column>
                  <el-table-column label="工作日同比" prop="workDayAvgFlowYoy"></el-table-column>
