<template>
  <div class="CyclingTime-wrapper nomap-content-container">
    <panelTitle title="车辆禁行区域预警统计" :displaySwitch="false" />
      ...
      <div class="item">
        ...
        >
          ...
          >
            ...
            <el-table-column label="序号" prop="2"></el-table-column>
            <el-table-column label="统计月份" prop="4"></el-table-column>
            <el-table-column label="时段（小时）" prop="5"></el-table-column>
            <el-table-column label="小时平均骑行次数" prop="6"></el-table-column>
            <el-table-column label="占骑行总次数%" prop="7"></el-table-column>
            <el-table-column label="小时平均骑行次数（节假日）" prop="8"></el-table-column>
            <el-table-column label="占骑行总次数%（节假日）" prop="9"></el-table-column>
            <el-table-column label="小时平均骑行次数（非节假日）" prop="10"></el-table-column>
            <el-table-column label="占骑总行次数%（非节假日）" prop="11"></el-table-column>
          </el-table>
        </TableAndPagination>
      </div>
    </section>
