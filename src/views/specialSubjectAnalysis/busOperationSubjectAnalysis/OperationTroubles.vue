<template>
    <div class="OperationTroubles-wrapper">
    <!-- <h2>行政处罚</h2> -->
        <!-- 搜索开始 -->
            ...
            <div class="item">
                ...
                >
                    <el-table style="width: 100%;height:100%;overflow-y: auto" :height="tableHeight" :data="tableData" stripe ref="table" >
                        ...
                        <el-table-column label="经营企业" prop="2"></el-table-column>
                        <el-table-column label="故障次数" prop="4"></el-table-column>
