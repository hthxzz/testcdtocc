<template>
    <div class="BusPunctuality-wrapper">

        <div  class="blsz" style="top: 3%;">
            <span class="title" style="padding-left: 2%">公共交通正点率设置</span>
            <hr>
            <div class="content">
                    ...
                    <div class="second">
                        <div class="top">
                            <div class="left">
                                <div class="one">
                                    <div><span style="">∑ (</span>
                                        <input class="normal" v-model="a" placeholder="始发正点班次" title="始发正点班次"></input> +
                                        <input  class="normal" v-model="b" placeholder="末站到站正点班次" title="末站到站正点班次"></input>
                                        <span>)</span></div>
                                    <hr style="width:100%" />
                                    <div ><span style="">∑ (</span><input  v-model="c" placeholder="计划发车班次" title="计划发车班次"></input><span> X2)</span></div>
                                </div>
                                <div class="two">
                                     X 100%
                                </div>
                            ...
                            <div class="right">
                                <div class="one">
                                    <div><span style="">∑ (</span>
                                        <input class="normal" v-model="d" placeholder="始发正点列数" title="始发正点列数"></input> +
                                        <input  class="normal" v-model="e" placeholder="末站到站正点列数" title="末站到站正点列数"></input>
                                        <span> )</span></div>
                                    <hr style="width:100%" />
                                    <div ><span style="">∑ (</span><input  v-model="f" placeholder="计划开行列数" title="计划开行列数"></input><span> X2)</span></div>
                                </div>
                                <div class="two">
                                    X 100%
                                </div>
        ...
        <div  class="blcx">
            <span class="title"style="padding-left: 2%">公共交通正点率</span>
            <hr>
...
<script>
    ...
    export default {
        ...
        methods:{
            dealWithData(){
                var one=this.c==''?0:((this.a==''?0:parseFloat(this.a))+(this.b==''?0:parseFloat(this.b)))/(parseFloat(this.c)*2)*100;
                var two=this.f==''?0:((this.d==''?0:parseFloat(this.d))+(this.e==''?0:parseFloat(this.e)))/(parseFloat(this.f)*2)*100;
            ...
            installData(){
                ...
                var param={
                    ...
                    busDepartOnTimeShift:this.a,
                    busLastStationOnTimeShift:this.b,
                    busScheduledShift:this.c,
                    trackDepartOnTimeShift:this.d,
                    trackLastStationOnTimeShift:this.e,
                    trackScheduledShift:this.f,
                    resultVlue:this.dealedData,

                };
                var url="gjjc_cityIndexSet/setPunctualityPubTransport";
            ...
            getdata(queryParam){
                ...
                this.$http.$get("gjjc_cityIndexSet/queryIndexInfo",queryParam).then((param) => {
                    ...
                    this.b=param&&param.groupOneDivisorSecond?param.groupOneDivisorSecond:'';
                    this.c=param&&param.groupOneDividend?param.groupOneDividend:'';
                    this.d=param&&param.groupTwoDivisor?param.groupTwoDivisor:'';
                    this.e=param&&param.groupTwoDivisorSecond?param.groupTwoDivisorSecond:'';
                    this.f=param&&param.groupTwoDividend?param.groupTwoDividend:'';
                });
            },
        ...
        data() {
            return {
                ...
                indexCode:'PunctualityPubTransport',
                dealedData:'',
                a:'',
                b:'',
                c:'',
